...
const ERROR_NOTFOUND_EMPLOYEE = {status: 400, message: 'Nenhum registro encontrado'}
...
const ALL_EMPLOYEE = {status: 201, message: 'Funcionario verificado com sucesso.'}
